...
class MULTIPKS_API UTP_WeaponComponent : public USkeletalMeshComponent
{
	GENERATED_BODY()
...
public:
	...
	TSubclassOf<class AMultiPKSProjectile> ProjectileClass;
	...
	bool AttachWeapon(AMultiPKSCharacter* TargetCharacter);
