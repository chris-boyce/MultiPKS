	...
	if (ProjectileClass != nullptr)
	{
		...
		if (World != nullptr)
		{
			...
			else
			{
				...
				World->SpawnActor<AMultiPKSProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
...
void UTP_WeaponComponent::Server_OnFire_Implementation(FVector Location, FRotator Rotation)
{
	...
	FActorSpawnParameters ActorSpawnParams;
	ActorSpawnParams.SpawnCollisionHandlingOverride = ESpawnActorCollisionHandlingMethod::AdjustIfPossibleButDontSpawnIfColliding;
	GetWorld()->SpawnActor<AMultiPKSProjectile>(ProjectileClass, Location, Rotation, ActorSpawnParams);
}
...
bool UTP_WeaponComponent::AttachWeapon(AMultiPKSCharacter* TargetCharacter)
{
